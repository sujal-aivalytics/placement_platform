...
import { Plus, Trash2, ArrowLeft, Save, Code, List } from 'lucide-react';
...
export default function QuestionsPage() {
    ...
    const handleEditQuestion = (q: Question) => {
        ...
        setCurrentQ({
            ...
            marks: q.marks || (q.type === 'coding' ? 15 : 1),
            options: opts,
    ...
    return (
        <div className="p-8 space-y-8 max-w-7xl mx-auto">
            <div className="flex items-center justify-between">
                <div>
                    <Button variant="ghost" onClick={() => router.push('/admin/mock-tests')} className="mb-4">
                        ...
                        <CardContent className="space-y-6">
                            <div className="grid grid-cols-2 gap-4">
                                <div className="space-y-2">
                                    ...
                                    <Select
                                        value={currentQ.type}
                                        onValueChange={(v) => setCurrentQ({ ...currentQ, type: v, marks: v === 'coding' ? 15 : 1 })}
                                    >
